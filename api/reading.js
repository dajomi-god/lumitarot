...
- 리딩 성공 기준: 읽은 후 내담자가 '명쾌해졌다', '위로됐다', '내 얘기다'를 느끼는 것. 정보 전달보다 감정적 공명이 목표
- 과거/현재/미래 첫 문장은 카드 설명이 아니라 내담자가 지금 느끼고 있을 감정에서 시작할 것
- 카드 키워드를 리딩 문장에 직역하지 말 것. '기브앤테이크', '공정성', '추진력', '자이가르닉 효과' 같은 단어를 그대로 쓰면 카드 사전과 다를 게 없음. 반드시 이 사람의 상황 언어로 번역할 것
