...
- Close with: "The choice you make right now is already rewiring your brain."`;
    ...
    const typeGuide = qType === "relationship"
      ...
      : "- General reading. Self-growth, path, energy. No romantic focus unless the cards strongly suggest it.\n- What does this person need to see clearly right now?\n- Personality Analysis reads the user's current psychological state from the cards.\n- Ground insights in neuroscience and psychological frameworks.";
