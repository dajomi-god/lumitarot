...
- 지금 이 선택이 당신의 뇌를 바꾸고 있어요 식의 마무리로 희망적이면서 과학적 근거 제시`;
    ...
    const revisitGuide = qType === "couple"
      ? ""
      : qType === "ex"
      ? "마지막 문장은 반드시: 1개월 후 마음이 정리됐을 때 다시 카드를 뽑아보세요. 지금과 어떤 카드가 달라졌는지가 중요한 신호예요."
      : qType === "some"
      ? "마지막 문장은 반드시: 2~3주 후 상황이 어떻게 바뀌었는지 다시 카드를 뽑아보세요. 지금과 어떤 카드가 달라졌는지가 중요한 신호예요."
      : "마지막 문장은 반드시: 1개월 후 내면이 어떻게 달라졌는지 다시 카드를 뽑아보세요. 지금과 어떤 카드가 달라졌는지가 중요한 신호예요.";
